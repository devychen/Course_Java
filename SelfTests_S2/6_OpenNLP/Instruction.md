# Self-Test 6 OPEN NLP

Write a class CorpusBuilder which takes a String in the constructor and creates POS and Lemma annotations for the text with OpenNLP.
